...
function validarCPF(){
    ...
    if(!cpf || cpf.length !=11 || cpf == "00000000000" || cpf == "11111111111" || cpf == "22222222222" || cpf == "33333333333" || cpf == "44444444444" || cpf == "66666666666" || cpf == "77777777777" || cpf == "88888888888" || cpf == "99999999999"){
        return false;
    } 
...
function gerar_json(form){
    ...
    if(formularioValido){
        document.write("<h2>Returno em Json</h2>");
        document.write(JSON.stringify(dados, null, '<br>'));
    }else{
        alert("Preencha todos os campos de forma correta, não deixe nenhum campo vazio!");
        document.form.focus();
        return false;
    }
    return true;
